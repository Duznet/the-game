describe "Protocol supporting server", ->
  ...
  describe "Signup action", ->
    ...
    it "should respond with 'userExists' if this user already exists", ->
  ...
  describe "Signin action", ->
    ...
    it "should respond with 'incorrect' if user with requested login doesn't exists", ->
    ...
    it "should respond with 'incorrect' if login and password don't match", ->
